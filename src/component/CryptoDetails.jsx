      ...
      <Col className='stats-container'>
        <Col className='coin-value-statistics'>
          ...
          {stats.map(({title,value,icon})=>(
                          ...
                          <Col className='coin-stats-name'>
                            ...
                            <Text className='stats'>{value==="undefined" ? 0 : value }</Text>
                          </Col>
        ...
        <Col className='coin-value-info'>
          <Col className='coin-value-statistics-heading'>
            ...
            <p>An overview showing the statistics of Cryptos</p>
          </Col>
          {genericStats.map(({title,value,icon})=>(
                          ...
                          <Col className='coin-stats-name'>
                            ...
                            <Text className='stats'>{value === "null" ? 0 : value}</Text>
                          </Col>
                    ...
                    {cryptoDetails?.links.map((link)=> (
                      ...
                      <Title level={5} className='link-name'>
                        {link?.type}
                            ...
                            <a href={link.websiteUrl} target='_blank'>{link.name}</a>
